...
const projects: Project[] = [
  {
    ...
    tags: ['Wordpress', 'WP Bakery', 'Responsive Design'],
  ...
  },
  {
    ...
    category: 'Web Development',
    description: 'Modern website that advertises tutoring and presents information in a clear format.',
  ...
  },
  {
    ...
    tags: ['React.js', 'Vite', 'SEO Optimization'],
    link: '#',
  },
  {
    id: 4,
    ...
    tags: ['React.js', 'Back-end Development', 'SEO Optimization'],
    link: '#',
  },
  {
    id: 5,
